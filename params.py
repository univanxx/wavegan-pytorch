...
# Model Params
#############################
model_prefix = 'exp7_longer' # name of the model to be saved
n_iterations = 250000
use_batchnorm = False
lr_g = 1e-4
lr_d = 1e-4 # you can use with discriminator having a larger learning rate than generator instead of using n_critic updates ttur https://arxiv.org/abs/1706.08500
beta1 = 0.5
beta2 = 0.9
...
n_critic = 5 # update generator every n_critic steps if lr_g = lr_d the n_critic's default value is 5 
